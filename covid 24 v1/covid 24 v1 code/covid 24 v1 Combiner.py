...
casesToTest = 26 #specify how many cases we want to test
...
bst2.load_model('../covid 24 v1 models/covid 24 v1 Seed2.model')  
...
bst8.load_model('../covid 24 v1 models/covid 24 v1 Seed8.model')  
...
bst24.load_model('../covid 24 v1 models/covid 24 v1 Seed24.model')  
...
bst64.load_model('../covid 24 v1 models/covid 24 v1 Seed64.model')  
...
bst256.load_model('../covid 24 v1 models/covid 24 v1 Seed256.model')  
...
for i in range(len(labels_predict2)):
	if patientNum.count(i) > 0:
		if labels_predict2[i].round() + labels_predict8[i].round() + labels_predict24[i].round() + labels_predict64[i].round() + labels_predict256[i].round() > 2:
			oxygen.append(1)
		else:
			oxygen.append(0)
