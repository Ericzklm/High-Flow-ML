...
inputTrain, inputTest, outputTrain, outputTest = train_test_split(inputData, outputData, test_size = .3, random_state = 256)
...
model.save_model('../covid 48 v1 models/covid 48 v1 Seed256.model')
